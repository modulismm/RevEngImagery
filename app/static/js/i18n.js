...
const STRINGS = {
  en: {
    ...
    recordNeedsHttps: 'Recording needs a secure (https) connection. Ask the person running the session.',
    recordOldDevice: 'This iPad is too old to record sound (iOS 14.3 or newer is needed). You can still choose a sound.',
    recordNoMic: 'No microphone was found.',
    joinTitle: 'Welcome', joinIntro: 'Type your name and choose a passphrase you will remember.',
    joinName: 'Your name', joinNameHint: 'Your full name is fine. This is how your pictures will be signed.',
    joinConsent: 'I agree that my pictures and recordings are kept for this project.',
    joinConsentMore: 'You can ask for them to be deleted at any time.',
    joinButton: 'Continue', joinReturning: 'If you have been here before, use the same name and passphrase.',
    myPictures: 'My pictures', groupPictures: 'Our group', newPicture: 'New picture',
    step1: 'Choose a picture', step2: 'Touch the picture where you want a sound',
    step3: 'Record your voice, or choose a sound',
    recordMyVoice: 'Record my voice', chooseASound: 'Choose a sound',
    advanced: 'More settings', listen: 'Listen', done: 'Done',
  ...
  fr: {
    ...
    recordNeedsHttps: 'L’enregistrement exige une connexion sécurisée (https). Demandez à la personne qui anime.',
    recordOldDevice: 'Cet iPad est trop ancien pour enregistrer (iOS 14.3 ou plus récent). Vous pouvez tout de même choisir un son.',
    recordNoMic: 'Aucun microphone n’a été trouvé.',
    joinTitle: 'Bienvenue', joinIntro: 'Écrivez votre nom et choisissez une phrase secrète dont vous vous souviendrez.',
    joinName: 'Votre nom', joinNameHint: 'Votre nom complet convient. C’est ainsi que vos images seront signées.',
    joinConsent: 'J’accepte que mes images et mes enregistrements soient conservés pour ce projet.',
    joinConsentMore: 'Vous pouvez demander leur suppression à tout moment.',
    joinButton: 'Continuer', joinReturning: 'Si vous êtes déjà venu, reprenez le même nom et la même phrase secrète.',
    myPictures: 'Mes images', groupPictures: 'Notre groupe', newPicture: 'Nouvelle image',
    step1: 'Choisissez une image', step2: 'Touchez l’image à l’endroit où vous voulez un son',
    step3: 'Enregistrez votre voix, ou choisissez un son',
    recordMyVoice: 'Enregistrer ma voix', chooseASound: 'Choisir un son',
    advanced: 'Réglages avancés', listen: 'Écouter', done: 'Terminé',
